...
I always console.log to ensure I haven't messed anything up. It's also good to make sure that anything your posting, putting, or deleting is correct before you do it.

3. Describe how web servers work.

Web servers hold data for people to access through axios calls. Basically it holds databases.
